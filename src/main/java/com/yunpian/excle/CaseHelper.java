...
public class CaseHelper {
	//根据excel的map 转换为数组 第一个为 入参 map 第二个为用例说明,第三个参数为执行用例期望结果
    public static Object[] getObjArrByMap(Map<String,String> caseExcelMap){
        ...
        Map<String,String> caseParam1 = new HashMap<String,String>();
        ...
        CaseInfo ci = new CaseInfo();
         ...
         caseParam1 = SortMap.sortMapByKey(caseParam);                
         ci.setCaseDesc(caseDesc);
         ci.setCaseParam(caseParam1);
