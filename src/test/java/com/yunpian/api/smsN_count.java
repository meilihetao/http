...
public class smsN_count extends base{
	 protected String caseExcelPath ="src/test/resource/smsN_count.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_smsN_count(CaseInfo c) throws IOException{
	        String url = Urlparams.smsN_count; 
