...
public class add_blacklist extends base{
	protected String caseExcelPath ="src/test/resource/add_blacklist.xlsx";
	...
	@Test(dataProvider = "dataInfo")
		public void test_add_blacklist(CaseInfo c) throws IOException{
        String url = Urlparams.add_blacklist; 
