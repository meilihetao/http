...
public class signNpost extends base{
	    protected String caseExcelPath ="src/test/resource/signGpost.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_signGpost(CaseInfo c) throws IOException{
	        String url = Urlparams.signGpost; 
