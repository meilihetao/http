...
public class getNDetail extends base{
	protected String caseExcelPath ="src/test/resource/getNDetail.xlsx";
	...
	@Test(dataProvider = "dataInfo")
		public void test_getNDetail(CaseInfo c) throws IOException{
        String url = Urlparams.getNDetail; 
