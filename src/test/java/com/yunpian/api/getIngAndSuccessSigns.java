...
public class getIngAndSuccessSigns extends base{
	 protected String caseExcelPath ="src/test/resource/getIngAndSuccessSigns.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_getIngAndSuccessSigns(CaseInfo c) throws IOException{
	        String url = Urlparams.getIngAndSuccessSigns; 
