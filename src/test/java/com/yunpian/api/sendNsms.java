...
public class sendNsms extends base{
	 protected String caseExcelPath ="src/test/resource/sendNsms.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_sendNsms(CaseInfo c) throws IOException{
	        String url = Urlparams.sendNsms; 
