...
public class Wcountry extends base{
	protected String caseExcelPath ="src/test/resource/Wcountry.xlsx";
	...
	@Test(dataProvider = "dataInfo")
		public void test_Wcountry(CaseInfo c) throws IOException{
        String url = Urlparams.Wcountry; 
