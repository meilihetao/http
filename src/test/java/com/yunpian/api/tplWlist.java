...
public class tplWlist extends base{
	 protected String caseExcelPath ="src/test/resource/tplWlist.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_tplWlist(CaseInfo c) throws IOException{
	        String url = Urlparams.tplWlist; 
