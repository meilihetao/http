...
public class Warrive extends base{
	 protected String caseExcelPath ="src/test/resource/Warrive.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_Warrive(CaseInfo c) throws IOException{
	        String url = Urlparams.Warrive; 
