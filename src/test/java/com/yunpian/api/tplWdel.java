...
public class tplWdel extends base{
	 protected String caseExcelPath ="src/test/resource/tplWdel.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_tplWdel(CaseInfo c) throws IOException{
	        String url = Urlparams.tplWdel; 
