...
public class smsW_record extends base{
	protected String caseExcelPath ="src/test/resource/smsW_record.xlsx";
	...
	@Test(dataProvider = "dataInfo")
		public void test_smsW_record(CaseInfo c) throws IOException{
        String url = Urlparams.smsW_record; 
