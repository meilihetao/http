...
public class pushTest extends base{
    protected String caseExcelPath ="src/test/resource/pushTest.xlsx";
	...
	@Test(dataProvider = "dataInfo")
		public void test_pushTest(CaseInfo c) throws IOException{
        String url = Urlparams.pushTest; 
        String response = HttpClientUtil.dopost(url, c.getCaseParam(),""); 
//        System.out.println(response);       
        String actvalue= Jsonfetch.json_string(response, "code");
