...
public class remove_blacklist extends base{
    protected String caseExcelPath ="src/test/resource/remove_blacklist.xlsx";
	...
	@Test(dataProvider = "dataInfo")
		public void test_remove_blacklist(CaseInfo c) throws IOException{
        String url = Urlparams.remove_blacklist; 
