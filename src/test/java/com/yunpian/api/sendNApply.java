...
public class sendNApply extends base{
	 protected String caseExcelPath ="src/test/resource/sendNApply.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_sendNApply(CaseInfo c) throws IOException{
	        String url = Urlparams.sendNApply; 
