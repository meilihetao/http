...
public class tplNlist extends base{
	 protected String caseExcelPath ="src/test/resource/tplNlist.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_tplNlist(CaseInfo c) throws IOException{
	        String url = Urlparams.tplNlist; 
