...
public class Nhistory extends base{
	 protected String caseExcelPath ="src/test/resource/Nhistory.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_Nhistory(CaseInfo c) throws IOException{
	        String url = Urlparams.Nhistory; 
