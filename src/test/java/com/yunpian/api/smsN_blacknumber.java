...
public class smsN_blacknumber extends base{
	 protected String caseExcelPath ="src/test/resource/smsN_blacknumber.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_smsN_blacknumber(CaseInfo c) throws IOException{
	        String url = Urlparams.smsN_blacknumber; 
