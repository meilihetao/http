...
public class regNSmsStat {
	 protected String caseExcelPath ="src/test/resource/regNSmsStat.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_regNSmsStat(CaseInfo c) throws IOException{
	        String url = Urlparams.regNSmsStat; 
