...
public class signNdelete extends base{
	 protected String caseExcelPath ="src/test/resource/signNdelete.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_signNdelete(CaseInfo c) throws IOException{
	        String url = Urlparams.signNdelete; 
