...
public class signNsearch extends base{
	 protected String caseExcelPath ="src/test/resource/signGsearch.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_signGsearch(CaseInfo c) throws IOException{
	        String url = Urlparams.signGsearch; 
