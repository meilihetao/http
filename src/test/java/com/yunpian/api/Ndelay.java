...
public class Ndelay extends base{
	 protected String caseExcelPath ="src/test/resource/Ndelay.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_Ndelay(CaseInfo c) throws IOException{
			String actvalue;
	        String url = Urlparams.Ndelay; 
	        String response = HttpClientUtil.dopost(url, c.getCaseParam(),"","1"); 
//	        System.out.println(response);  
	        if (Jsonfetch.json_string1(response, "percent") !=null) {
	          	actvalue = "0";
	        }else {
