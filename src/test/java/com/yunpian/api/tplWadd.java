...
public class tplWadd extends base{
	 protected String caseExcelPath ="src/test/resource/tplWadd.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_tplWadd(CaseInfo c) throws IOException{
	        String url = Urlparams.tplWadd; 
	        String actvalue;
	        String response = HttpClientUtil.dopost(url, c.getCaseParam(),"","1"); 
	        System.out.println(response);   
	        if (Jsonfetch.json_string1(response, "code").contentEquals("2") ) {
	        	     actvalue = "0";
	        }else {
