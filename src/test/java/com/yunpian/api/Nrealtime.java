...
public class Nrealtime extends base{
	 protected String caseExcelPath ="src/test/resource/Nrealtime.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_Nrealtime(CaseInfo c) throws IOException{
	        String url = Urlparams.Nrealtime; 
