...
public class tplNadd extends base{
	 protected String caseExcelPath ="src/test/resource/tplNadd.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_tplNadd(CaseInfo c) throws IOException{
	        String url = Urlparams.tplNadd; 
