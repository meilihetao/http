...
public class getHistoryContentList extends base{
	 protected String caseExcelPath ="src/test/resource/getHistoryContentList.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_getHistoryContentList(CaseInfo c) throws IOException{
	        String url = Urlparams.getHistoryContentList; 
