...
public class whiteGNTest extends base{
protected String caseExcelPath ="src/test/resource/whiteNTest-get.xlsx";
	...
	@Test(dataProvider = "dataInfo")
		public void test_whiteGNTest(CaseInfo c) throws IOException{
		String actvalue = null;
        String url = Urlparams.whiteGNTest; 
