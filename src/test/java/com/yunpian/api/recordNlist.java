...
public class recordNlist extends base{
	 protected String caseExcelPath ="src/test/resource/recordNlist.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_recordNlist(CaseInfo c) throws IOException{
	        String url = Urlparams.recordNlist; 
