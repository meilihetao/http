...
public class tplNdel extends base{
	 protected String caseExcelPath ="src/test/resource/tplNdel.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_tplNdel(CaseInfo c) throws IOException{
	        String url = Urlparams.tplNdel; 
