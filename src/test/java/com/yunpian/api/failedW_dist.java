...
public class failedW_dist extends base{
	 protected String caseExcelPath ="src/test/resource/failedW_dist.xlsx";
		...
		@Test(dataProvider = "dataInfo")
			public void test_failedW_dist(CaseInfo c) throws IOException{
	        String url = Urlparams.failedW_dist; 
